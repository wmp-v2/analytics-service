docker-build:
	...
	docker build -t 471451201019.dkr.ecr.us-east-1.amazonaws.com/analytics-service:${image_tag}	 .
	docker push 471451201019.dkr.ecr.us-east-1.amazonaws.com/analytics-service:image_tag=${image_tag}
